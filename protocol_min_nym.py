...
def run_full_protocol(away_team, home_team, away_sp_name, home_sp_name,
    ...
    print(f"  Park Factor:  {park_factor} (Pitcher Environment)")
...
if __name__ == '__main__':
    AWAY_LINEUP = [
        ...
        ('Ryan Jeffers', 'R'), ('Kody Clemens', 'L'), ('L. Keaschall', 'R'),
        ('Matt Wallner', 'L'), ('Royce Lewis', 'R'), ('Brooks Lee', 'S'),
    ]
    HOME_LINEUP = [
        ('M. Semien', 'R'), ('Juan Soto', 'L'), ('Luis Robert', 'R'),
        ('Bo Bichette', 'R'), ('MJ Melendez', 'L'), ('F. Alvarez', 'R'),
        ('Mark Vientos', 'R'), ('Brett Baty', 'L'), ('Carson Benge', 'L'),
    ]
    run_full_protocol(
        'MIN', 'NYM', 'Joe Ryan', 'Christian Scott', 'R', 'R',
        3.29, 0.00, AWAY_LINEUP, HOME_LINEUP, 96, False, 55, 4
    )
