...
#!/usr/bin/env python3
"""
MLB QUANT-ELITE V6.5 — THE COMPREHENSIVE ENGINE
Fixes: V6.4 + Correlated K-Rate Decay, Aggressive Dynamic Hooking, Over-Bet Warnings
"""
import csv, random, math, statistics
from collections import Counter
import datetime

random.seed()  # V6.5.1: Dynamic seed — fixed seed invalidated Monte Carlo variance
N_SIMS = 100000
...
def simulate_game_v6_5(away_sp_stats, home_sp_stats, away_bp, home_bp, 
    ...
    for i in range(N_SIMS):
        ...
        # K-Decay Calibrated with Umpire Zone & Run Penalty
        ...
        raw_a_k_mu = base_a_k_mu * wrc_k_adj_a * umpire_k_mod * run_penalty_a
        ...
        raw_h_k_mu = base_h_k_mu * wrc_k_adj_h * umpire_k_mod * run_penalty_h
        home_sp_k_dist.append(poisson_rvs(raw_h_k_mu))
        
    return away_total_runs, home_total_runs, away_sp_k_dist, home_sp_k_dist

def run_v6_5_protocol(away_team, home_team, away_sp_name, home_sp_name,
    ...
    print(f"╔══════════════════════════════════════════════════════════════════╗")
    print(f"║        MLB QUANT-ELITE V6.5 | THE COMPREHENSIVE ENGINE        ║")
    ...
    print(f"\n==================================================================")
    print(f"  V6.5 FINAL: {away_team} {away_mu:.2f} — {home_team} {home_mu:.2f}")
    print(f"==================================================================")
...
if __name__ == '__main__':
    ...
    run_v6_5_protocol('LAA', 'KCR', 'Walbert Urena', 'Cole Ragans', 'R', 'L',
