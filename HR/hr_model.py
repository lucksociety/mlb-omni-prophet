...
class HRModel:
    ...
    - Calibrated Poisson probability engine
    """
    ...
    def __init__(self, stats_path):
        ...
        career_path = stats_path.replace("MLB Stats", "MLB Stats Career")
        if not os.path.exists(career_path):
            career_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "MLB Stats Career.csv")
    ...
    def calculate_hr_probability(self, batter_name, pitcher_name, batter_index=0, opp_team_name="League Avg", park_factor=100, 
        ...
        # ── 6. DYNAMIC PA ENGINE & POISSON PROBABILITY ───────────────
