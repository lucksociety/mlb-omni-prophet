...
def run_sim():
    # WSH Lineup from confirmed lineup image
    wsh_lineup = [
        ('James Wood', 'L'),
        ('Luis Garcia', 'L'),
        ('Daylen Lile', 'L'),
    ...
    # NYM Lineup from confirmed lineup image
    nym_lineup = [
        ('Bo Bichette', 'R'),
        ('Juan Soto', 'L'),
        ('MJ Melendez', 'L'),
    ...
    # WSH @ NYM | 1:10 PM ET
    # WSH SP: Miles Mikolas (R), 8.49 ERA (from image)
    # NYM SP: Freddy Peralta (R), 3.90 ERA
    # Weather: Assuming 60F, 5mph (Citi Field)
    
    print("\n🚀 EXECUTING QUANT-ELITE V6.4: WSH @ NYM...")
    ...
    ar, hr, a_k, h_k = run_v6_4_protocol(
        ...
        away_drs=1, 
        home_drs=2, 
        away_manager_hook=-0.5, # Mikolas on short leash
