...
ATH @ SEA | April 22, 2026 | 4:10 PM ET
CONFIRMED LINEUPS
"""
...
AWAY_LINEUP = [
    ('Nick Kurtz', 'L'), ('S. Langeliers', 'R'), ('C. Cortes', 'L'),
    ('T. Soderstrom', 'L'), ('Jacob Wilson', 'R'), ('Jeff McNeil', 'L'),
    ('Max Muncy', 'R'), ('L. Butler', 'L'), ('Austin Wynns', 'R'),
]
HOME_LINEUP = [
    ('J. Crawford', 'L'), ('Cal Raleigh', 'S'), ('J. Rodriguez', 'R'),
    ('Josh Naylor', 'L'), ('R. Arozarena', 'R'), ('Luke Raley', 'L'),
    ('D. Canzone', 'L'), ('Cole Young', 'L'), ('Leo Rivas', 'S'),
]
...
def main():
    ...
    print(f"║        {AWAY} @ {HOME} | {datetime.datetime.now().strftime('%B %d, %Y')} | 4:10 PM ET           ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
    ...
    print(f"  Venue:        T-Mobile Park | DOME (roof closed)")
    ...
    if PARK_FACTOR < 98:
        print(f"  ⚠ T-Mobile Park is pitcher-friendly (PF {PARK_FACTOR})")
