...
def run_full_protocol(away_team, home_team, away_sp_name, home_sp_name,
    ...
    print(f"  Venue:        Globe Life Field | {temp_f}°F | Dome")
...
if __name__ == '__main__':
    ...
    HOME_LINEUP = [
        ...
        ('K. Higashioka', 'R'), ('Josh Smith', 'L'), ('E. Duran', 'R'),
    ]
    run_full_protocol(
        'PIT', 'TEX', 'Bubba Chandler', 'Jacob deGrom', 'R', 'R',
        3.15, 2.29, AWAY_LINEUP, HOME_LINEUP, 102, True, 75, 0
    )
