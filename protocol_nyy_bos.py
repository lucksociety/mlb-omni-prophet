...
def run_full_protocol(away_team, home_team, away_sp_name, home_sp_name,
    ...
    print(f"  Park Factor:  {park_factor} (Hitter Environment)")
...
if __name__ == '__main__':
    AWAY_LINEUP = [
        ('Amed Rosario', 'R'), ('Aaron Judge', 'R'), ('Ben Rice', 'L'),
        ('G. Stanton', 'R'), ('C. Bellinger', 'L'), ('R. Grichuk', 'R'),
        ('J. Chisholm', 'L'), ('J. Caballero', 'R'), ('Austin Wells', 'L'),
    ]
    HOME_LINEUP = [
        ('Jarren Duran', 'L'), ('C. Rafaela', 'R'), ('Wilyer Abreu', 'L'),
        ('W. Contreras', 'R'), ('M. Yoshida', 'L'), ('Trevor Story', 'R'),
        ('M. Mayer', 'L'), ('Caleb Durbin', 'R'), ('C. Narvaez', 'R'),
    ]
    run_full_protocol(
        'NYY', 'BOS', 'Cam Schlittler', 'Payton Tolle', 'R', 'L',
        1.95, 0.00, AWAY_LINEUP, HOME_LINEUP, 105, False, 52, 12, wind_ang=225 # In from RF
    )
