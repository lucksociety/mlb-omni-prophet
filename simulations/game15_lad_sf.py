...
LAD @ SF | April 22, 2026 | 9:45 PM ET
EXPECTED LINEUPS
"""
...
def main():
    ...
    print(f"║        {AWAY} @ {HOME} | {datetime.datetime.now().strftime('%B %d, %Y')} | 9:45 PM ET           ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
    ...
    if PARK_FACTOR < 98:
        print(f"  ⚠ Oracle Park is pitcher-friendly (PF {PARK_FACTOR})")
