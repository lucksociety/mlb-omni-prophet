...
CWS @ ARI | April 22, 2026 | 9:40 PM ET
EXPECTED LINEUPS
"""
...
AWAY_LINEUP = [
    ...
    ('E. Pereira', 'R'), ('Edgar Quero', 'S'), ('C. Montgomery', 'L'),
    ('T. Murray', 'R'), ('Derek Hill', 'R'), ('L. Acuna', 'R'),
]
HOME_LINEUP = [
    ('Ketel Marte', 'S'), ('C. Carroll', 'L'), ('G. Perdomo', 'S'),
    ('N. Arenado', 'R'), ('L. Gurriel', 'R'), ('J. Fernandez', 'R'),
    ('Tim Tawa', 'R'), ('J. Barrosa', 'S'), ('James McCann', 'R'),
]
...
def main():
    ...
    print(f"║        {AWAY} @ {HOME} | {datetime.datetime.now().strftime('%B %d, %Y')} | 9:40 PM ET           ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
    ...
    print(f"  Venue:        Chase Field | Dome (Controlled Env)")
    ...
    if PARK_FACTOR > 105:
        print(f"  ⚠ Chase Field effect active (PF {PARK_FACTOR})")
