...
def run_hou_cin_sim():
    away_lineup = [
        ...
        {'Name': 'Cesar Salazar', 'Hand': 'L', 'K_pct': 28.0, 'O_Swing': 32.0, 'Z_Contact': 78.0, 'wOBA': 0.180},
    ]
    ...
    game_data = {
        ...
        'home_sp_era': 5.13,
        'away_sp_statcast': {
            'Name': 'Cody Bolton', 'Hand': 'R', 'Stuff': 98,
            'K_pct': 25.0, 'BB_pct': 16.1, 'VAA': -4.4,
            'IP': 11.2, 'Starts': 3, 'ERA': 4.63, 'xERA': 4.42,
            'HR/FB%': 12.5, 'LastPitchCount': 75
        },
        'home_sp_statcast': {
            'Name': 'Andrew Abbott', 'Hand': 'L', 'Stuff': 102,
            'K_pct': 15.4, 'BB_pct': 10.4, 'VAA': -4.6,
            'IP': 40.1, 'Starts': 8, 'ERA': 5.13, 'xERA': 4.77,
            'HR/FB%': 11.1, 'LastPitchCount': 90
        },
        ...
        'park_factor': 112,
        'is_dome': False,
        'away_drs': -3, 'home_drs': 1,
        'away_manager_hook': 0.2, 'home_manager_hook': 0,
        'away_bp_pitches_d1': 20, 'away_bp_pitches_d2': 10,
        'home_bp_pitches_d1': 15, 'home_bp_pitches_d2': 10,
        'away_catcher': 'Cesar Salazar', 'home_catcher': 'Tyler Stephenson',
        'game_time_decimal': 13.67, 'game_time': '13:40',
        'location': 'CIN',
        'away_bp_avg_era': 4.30, 'home_bp_avg_era': 3.90,
        'env': {
            'Weather': {'temp': 66, 'wind_speed': 3, 'wind_dir': 0, 'humidity': 50},
            'altitude': 482, 'rain_intensity': 0.0,
            'Umpire': {'name': 'Unknown', 'zone_type': 'neutral'}
        }
    }

    # LIVE ODDS from sportsbook @ 1:41 PM ET
    market_odds = {
        'CIN Moneyline': -113,
        'HOU Moneyline': -107,
        'Total Over 9.0': -120,
