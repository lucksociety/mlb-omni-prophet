...
MIN @ NYM | April 22, 2026 | 7:10 PM ET
CONFIRMED LINEUPS
"""
...
# LINEUPS (name, hand)
AWAY_LINEUP = [
    ('Byron Buxton', 'R'), ('T. Larnach', 'L'), ('Josh Bell', 'S'),
    ('V. Caratini', 'S'), ('Kody Clemens', 'L'), ('L. Keaschall', 'R'),
    ('Matt Wallner', 'L'), ('Royce Lewis', 'R'), ('Brooks Lee', 'S'),
]
HOME_LINEUP = [
    ('Bo Bichette', 'R'), ('Juan Soto', 'L'), ('Luis Robert', 'R'),
    ('F. Lindor', 'S'), ('F. Alvarez', 'R'), ('Mark Vientos', 'R'),
    ('M. Semien', 'R'), ('Tommy Pham', 'R'), ('T. Taylor', 'R'),
]
...
def main():
    ...
    print(f"║        {AWAY} @ {HOME} | {datetime.datetime.now().strftime('%B %d, %Y')} | 7:10 PM ET           ║")
    print("╚══════════════════════════════════════════════════════════════════╝")
    ...
    print(f"  Venue:        Citi Field | {TEMP_F}°F | Wind {WIND_MPH} mph")
    ...
    if PARK_FACTOR < 98:
        print(f"  ⚠ Citi Field is pitcher-friendly (PF {PARK_FACTOR})")
