...
def run_full_protocol(away_team, home_team, away_sp_name, home_sp_name,
    ...
    print(f"  Venue:        Chase Field | {temp_f}°F | Dome")
...
if __name__ == '__main__':
    AWAY_LINEUP = [
        ('A. Benintendi', 'L'), ('M. Murakami', 'L'), ('M. Vargas', 'R'),
        ('C. Montgomery', 'L'), ('E. Pereira', 'R'), ('S. Antonacci', 'L'),
        ('Edgar Quero', 'S'), ('C. Meidroth', 'R'), ('L. Acuna', 'R'),
    ]
    HOME_LINEUP = [
        ('Ketel Marte', 'S'), ('C. Carroll', 'L'), ('G. Perdomo', 'S'),
        ('L. Gurriel', 'R'), ('A. Del Castillo', 'L'), ('J. Fernandez', 'R'),
        ('N. Arenado', 'R'), ('I. Vargas', 'S'), ('Alek Thomas', 'L'),
    ]
    run_full_protocol(
        'CWS', 'ARI', 'Davis Martin', 'Michael Soroka', 'R', 'R',
        2.16, 2.78, AWAY_LINEUP, HOME_LINEUP, 104, True, 75, 0
    )