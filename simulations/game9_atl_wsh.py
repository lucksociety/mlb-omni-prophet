...
ATL @ WSH | April 22, 2026 | 6:45 PM ET
CONFIRMED LINEUPS
"""
...
AWAY = 'ATL'
HOME = 'WSH'
AWAY_SP = 'Didier Fuentes'
HOME_SP = 'Zack Littell'
AWAY_SP_ERA = 2.25
HOME_SP_ERA = 7.11
...
AWAY_LINEUP = [
    ...
    ('M. Dubon', 'R'), ('M. Yastrzemski', 'L'), ('Jonah Heim', 'S'),
]
HOME_LINEUP = [
    ('James Wood', 'L'), ('Luis Garcia', 'L'), ('Brady House', 'R'),
    ('CJ Abrams', 'L'), ('Daylen Lile', 'L'), ('Jacob Young', 'R'),
    ('Jorbit Vivas', 'L'), ('Jose Tena', 'L'), ('Keibert Ruiz', 'S'),
]
...
PARK_FACTOR = 101  # Nationals Park
IS_DOME = False
TEMP_F = 69
WIND_MPH = 13
WIND_ANGLE = 90  
...
def main():
    ...
    print(f"  Venue:        Nationals Park | {TEMP_F}°F | Wind {WIND_MPH} mph")
    ...
    if PARK_FACTOR > 100:
        print(f"  ⚠ Nationals Park is slightly hitter-friendly (PF {PARK_FACTOR})")
