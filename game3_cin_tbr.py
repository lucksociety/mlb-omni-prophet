...
CIN @ TBR | April 22, 2026 | 1:10 PM ET
CONFIRMED LINEUPS + DOME
"""
...
AWAY = 'CIN'
HOME = 'TBR'
AWAY_SP = 'Brandon Williamson'
HOME_SP = 'Nick Martinez'
AWAY_SP_ERA = 4.35
HOME_SP_ERA = 2.45

# CONFIRMED LINEUPS (name, hand)
AWAY_LINEUP = [
    ('TJ Friedl', 'L'), ('Matt McLain', 'R'), ('E. De La Cruz', 'S'),
    ('Sal Stewart', 'R'), ('E. Suarez', 'R'), ('N. Lowe', 'L'),
    ('S. Steer', 'R'), ('Will Benson', 'L'), ('P.J. Higgins', 'R'),
]
HOME_LINEUP = [
    ('Yandy Diaz', 'R'), ('J. Aranda', 'L'), ('J. Caminero', 'R'),
    ('Ryan Vilade', 'R'), ('Jonny DeLuca', 'R'), ('B. Williamson', 'R'),
    ('C. Simpson', 'L'), ('Nick Fortes', 'R'), ('Taylor Walls', 'S'),
]
...
PARK_FACTOR = 93  # Tropicana Field (pitcher-friendly)
IS_DOME = True
TEMP_F = 72
WIND_MPH = 0

# Vegas: Not Specified, using model totals
...
def main():
    ...
    if PARK_FACTOR < 98:
        print(f"  ⚠ Tropicana Field is pitcher-friendly (PF {PARK_FACTOR}) → supports Under")
    
    # Both SP are R, check lineup handedness
    # B. Williamson is LHP, Nick Martinez is RHP
    ...
    print(f"  ℹ {HOME} has {mia_lefties}/9 LHB/SHB vs LHP {AWAY_SP}")
