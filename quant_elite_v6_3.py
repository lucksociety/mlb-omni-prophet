#!/usr/bin/env python3
"""
MLB QUANT-ELITE V6.3 — THE CALIBRATED ENGINE
Fixes: Adjusted Bullpen Decay, Calibrated Run Variance (sp_k=15), Realistic Betting Flags
"""
...
def simulate_game_v6_3(away_sp_stats, home_sp_stats, away_bp, home_bp, 
    ...
    sp_k = 15.0 
    if rain_intensity > 0.4: sp_k = 10.0
    ...
    for _ in range(N_SIMS):
        ...
        raw_a_k_mu = base_a_k_mu * wrc_k_adj_a
...
def run_v6_3_protocol(away_team, home_team, away_sp_name, home_sp_name,
    ...
    ar, hr, a_k, h_k = simulate_game_v6_3(away_sp_stats, home_sp_stats, away_bp, home_bp, 
    ...
    print(f"╔══════════════════════════════════════════════════════════════════╗")
    print(f"║        MLB QUANT-ELITE V6.3 | THE CALIBRATED ENGINE           ║")
...
if __name__ == '__main__':
    ...
    run_v6_3_protocol('LAA', 'KCR', 'Walbert Urena', 'Cole Ragans', 'R', 'L',
